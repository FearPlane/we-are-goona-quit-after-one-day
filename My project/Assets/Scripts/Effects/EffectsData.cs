using PokemonGame.Effects.Data;
using PokemonGame.Effects.Enums;
using PokemonGame.PokemonCore.Enums;
using UnityEngine.Serialization;

namespace PokemonGame.Effects
{
    [System.Serializable]
    public class EffectsData //Todo find the formulas for the effects and each stats
    {
        ...
        [FormerlySerializedAs("statData")] [FormerlySerializedAs("stat")] public BattleStat battleStat; //Which stat to modify (only for `statChange`)
